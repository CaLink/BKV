...
void RePrint(T ans,Fl_Input* who)
{
    ...
    switch (syst)
    {
    case 8: sprintf(str,"%o",ans); who->value((const char*)str);break;
    case 10: sprintf(str,"%d",ans);who->value((const char*)str);break;
    case 16:sprintf(str,"%x",ans);who->value((const char*)str);break;

    }

    switch (who->y())
    {
    case aiY: cA=ans; break;
    case biY: cB=ans; break;
    case ciY: cC=ans; break;
