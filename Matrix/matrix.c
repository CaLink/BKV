...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DETERM = 8,                     /* DETERM  */
  YYSYMBOL_INVERSE = 9,                    /* INVERSE  */
  YYSYMBOL_RAND = 10,                      /* RAND  */
  YYSYMBOL_QUIT = 11,                      /* QUIT  */
  YYSYMBOL_VAR = 12,                       /* VAR  */
  YYSYMBOL_FUNC = 13,                      /* FUNC  */
  YYSYMBOL_UNDF = 14,                      /* UNDF  */
  YYSYMBOL_15_ = 15,                       /* '='  */
  YYSYMBOL_16_ = 16,                       /* '+'  */
  YYSYMBOL_17_ = 17,                       /* '-'  */
  YYSYMBOL_18_ = 18,                       /* '*'  */
  ...
  YYSYMBOL_defmat = 33,                    /* defmat  */
  YYSYMBOL_matelem = 34,                   /* matelem  */
  YYSYMBOL_matlist = 35,                   /* matlist  */
  YYSYMBOL_assign = 36,                    /* assign  */
  YYSYMBOL_expr = 37,                      /* expr  */
  YYSYMBOL_matop = 38                      /* matop  */
};
...
static const yytype_int8 yytranslate[] =
{
      ...
      24,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      29,    30,    18,    16,    28,    17,     2,    19,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,    25,
       2,    15,     2,     2,    22,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,    26,     2,    27,    20,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MAT", "NUM", "INPUT",
  "OUTPUT", "DEFINE", "DETERM", "INVERSE", "RAND", "QUIT", "VAR", "FUNC",
  "UNDF", "'='", "'+'", "'-'", "'*'", "'/'", "'^'", "UNMIN", "'@'", "'~'",
  "'\\n'", "';'", "'['", "']'", "','", "'('", "')'", "$accept", "prog",
  "defmat", "matelem", "matlist", "assign", "expr", "matop", YY_NULLPTR
};
...
{
      45,    -7,   -16,     8,    14,    24,    30,   -16,    19,    31,
      79,   -16,    79,    18,    29,   -16,   -15,    37,    56,   -16,
     -16,    28,    35,    50,   -16,    60,    79,    55,   -16,    81,
     -16,    52,    54,   118,    57,   -16,    79,    79,    79,    79,
      79,   -16,   -16,    96,    51,    59,    79,    24,   -16,    64,
      65,    25,    86,    79,   -16,   -16,   -16,   -16,   -16,    66,
      66,    75,    75,    75,   104,   107,     3,    79,   124,   126,
     101,   -16,   127,   128,   -16,   -16,   -16,   -16,    25,    25,
     102,   109,    83,   110,   111,   -16,   -16,    79,   -16,   -16,
     106,   -16
};
...
{
       0,     0,    15,     0,     0,     0,     0,    26,    16,     0,
       0,     2,     0,     0,     0,    24,     0,     0,     0,    28,
      27,     0,    12,     0,    33,     0,     0,    16,    23,     0,
       1,     0,     0,     0,     0,     5,     0,     0,     0,     0,
       0,     3,     4,    32,     0,     0,     0,     0,    10,     0,
       0,    14,     0,     0,    25,     9,     7,     8,     6,    18,
      19,    20,    21,    22,     0,     0,     0,     0,     0,     0,
       0,    13,     0,     0,    17,    29,    30,    31,    38,    39,
       0,     0,     0,     0,     0,    36,    37,     0,    34,    35,
       0,    11
};
...
{
     -16,   -16,   130,   -16,    97,   -16,     0,   132
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,    13,    14,    22,    23,    15,    51,    17
};
...
{
      16,    36,    37,    38,    39,    40,    77,     2,    18,    41,
      28,    19,    29,    33,     7,    27,     9,    20,    30,    31,
      10,     1,     2,     3,     4,     5,    52,    21,     6,     7,
       8,     9,    12,    24,    25,    10,    59,    60,    61,    62,
      63,    36,    37,    38,    39,    40,    70,    12,     1,     2,
       3,     4,     5,    35,    46,     6,     7,     8,     9,    43,
      26,    42,    10,    47,     2,    44,    78,    79,    49,    11,
      53,     7,    27,     9,    12,    48,    55,    10,    56,    45,
      68,    58,    50,     2,    38,    39,    40,    90,    69,    12,
       7,    27,     9,    72,    73,    40,    10,    36,    37,    38,
      39,    40,    36,    37,    38,    39,    40,    75,    12,    87,
      76,    54,    64,    65,    66,    67,    74,    36,    37,    38,
      39,    40,    36,    37,    38,    39,    40,    80,    82,    81,
      83,    84,    85,    91,    36,    37,    38,    39,    40,    86,
      88,    89,    57,    32,    71,    34
};

static const yytype_int8 yycheck[] =
{
       0,    16,    17,    18,    19,    20,     3,     4,    15,    24,
      10,     3,    12,    13,    11,    12,    13,     3,     0,     1,
      17,     3,     4,     5,     6,     7,    26,     3,    10,    11,
      12,    13,    29,     3,    15,    17,    36,    37,    38,    39,
      40,    16,    17,    18,    19,    20,    46,    29,     3,     4,
       5,     6,     7,    24,    26,    10,    11,    12,    13,     3,
      29,    24,    17,    28,     4,     9,    66,    67,     8,    24,
      15,    11,    12,    13,    29,    25,    24,    17,    24,    23,
      29,    24,    22,     4,    18,    19,    20,    87,    29,    29,
      11,    12,    13,    29,    29,    20,    17,    16,    17,    18,
      19,    20,    16,    17,    18,    19,    20,     3,    29,    26,
       3,    30,    16,    17,    18,    19,    30,    16,    17,    18,
      19,    20,    16,    17,    18,    19,    20,     3,    27,     3,
       3,     3,    30,    27,    16,    17,    18,    19,    20,    30,
      30,    30,    24,    13,    47,    13
};
...
static const yytype_int8 yystos[] =
{
      ...
      17,    24,    29,    32,    33,    36,    37,    38,    15,     3,
       3,     3,    34,    35,     3,    15,    29,    12,    37,    37,
       0,     1,    33,    37,    38,    24,    16,    17,    18,    19,
      20,    24,    24,     3,     9,    23,    26,    28,    25,     8,
      22,    37,    37,    15,    30,    24,    24,    24,    24,    37,
      37,    37,    37,    37,    16,    17,    18,    19,    29,    29,
      37,    35,    29,    29,    30,     3,     3,     3,    37,    37,
       3,     3,    27,     3,     3,    30,    30,    26,    30,    30,
      37,    27
};
...
{{ int i,j,ind;
  ind = (char)(yyvsp[0].Name)-'a';
   ...
   printf("entering matrix %c ",(yyvsp[0].Name));
...
{{
  int ind;
  float num;
  ind=(char)(yyvsp[-1].Name)-'a';
  num=(yyvsp[-5].sym)->u.val;

  if(pm[ind]->rows==pm[ind]->cols)
  {
    num=Det(pm[ind]);
    printf("\ndet=%lf\n",num);
    (yyvsp[-5].sym)->u.val=num;
  }
...
ind1=(char)(yyvsp[-5].Name)-'a';
ind2=(char)(yyvsp[-1].Name)-'a';
