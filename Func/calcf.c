...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FUNC2 = 6,                      /* FUNC2  */
  YYSYMBOL_UNDF = 7,                       /* UNDF  */
  YYSYMBOL_8_ = 8,                         /* '='  */
  YYSYMBOL_9_ = 9,                         /* '+'  */
  YYSYMBOL_10_ = 10,                       /* '-'  */
  YYSYMBOL_11_ = 11,                       /* '*'  */
...
{
     -13,    16,   -13,   -11,   -13,    -4,    -7,     1,    31,   -13,
      31,   -13,    75,   -13,    31,    31,    31,    -6,    45,    31,
      31,    31,    31,    31,   -13,   -13,    83,    55,    34,   -13,
      12,    12,   -12,   -12,   -12,   -13,    31,    65,   -13
};
...
{
       2,     0,     1,     0,     7,     8,     0,     0,     0,     3,
       0,    17,     0,     5,     0,     0,     0,    16,     0,     0,
       0,     0,     0,     0,    19,     4,     6,     0,     0,    18,
      11,    12,    13,    14,    15,     9,     0,     0,    10
};
...
{
      17,    23,    18,    24,    14,    13,    26,    27,    28,    24,
      15,    30,    31,    32,    33,    34,     2,     3,    16,     4,
       5,     6,     7,    21,    22,    23,     8,    24,    37,     0,
       0,     0,     9,    10,     4,     5,     6,     7,     0,     0,
       0,     8,     0,    19,    20,    21,    22,    23,    10,    24,
       0,     0,     0,    36,    19,    20,    21,    22,    23,     0,
      24,     0,     0,    29,    19,    20,    21,    22,    23,     0,
      24,     0,     0,    35,    19,    20,    21,    22,    23,     0,
      24,     0,     0,    38,    19,    20,    21,    22,    23,     0,
      24,    25,    19,    20,    21,    22,    23,     0,    24
};

static const yytype_int8 yycheck[] =
{
       8,    13,    10,    15,     8,    16,    14,    15,    16,    15,
      17,    19,    20,    21,    22,    23,     0,     1,    17,     3,
       4,     5,     6,    11,    12,    13,    10,    15,    36,    -1,
      -1,    -1,    16,    17,     3,     4,     5,     6,    -1,    -1,
      -1,    10,    -1,     9,    10,    11,    12,    13,    17,    15,
      -1,    -1,    -1,    19,     9,    10,    11,    12,    13,    -1,
      15,    -1,    -1,    18,     9,    10,    11,    12,    13,    -1,
      15,    -1,    -1,    18,     9,    10,    11,    12,    13,    -1,
      15,    -1,    -1,    18,     9,    10,    11,    12,    13,    -1,
      15,    16,     9,    10,    11,    12,    13,    -1,    15
};
...
{
       0,    21,     0,     1,     3,     4,     5,     6,    10,    16,
      17,    22,    23,    16,     8,    17,    17,    23,    23,     9,
      10,    11,    12,    13,    15,    16,    23,    23,    23,    18,
      23,    23,    23,    23,    23,    18,    19,    23,    18
};
...
#line 1235 "calcf.c"
  ...
  case 4: /* prog: prog expr '\n'  */
#line 87 "calcf.y"
                   {  Val=(yyvsp[-1].val); /* printf("%lf\n",Val); */ /*WE=0;*/}
#line 1241 "calcf.c"
    break;

  case 5: /* prog: prog error '\n'  */
#line 88 "calcf.y"
                   {  yyerrok; printf("\007\n") ;}
#line 1247 "calcf.c"
    break;

  case 6: /* assign: VAR '=' expr  */
#line 90 "calcf.y"
...
#line 1265 "calcf.c"
  ...
  case 9: /* expr: FUNC '(' expr ')'  */
#line 94 "calcf.y"
                            {  (yyval.val) = (((yyvsp[-3].sym)->u.ptr)((yyvsp[-1].val))); }
#line 1271 "calcf.c"
    break;

  case 10: /* expr: FUNC2 '(' expr ',' expr ')'  */
#line 95 "calcf.y"
                                      { (yyval.val) = (((yyvsp[-5].sym)->u.ptr)((int)(yyvsp[-3].val),(yyvsp[-1].val))); }
#line 1277 "calcf.c"
    break;
...
#line 99 "calcf.y"
                            { if ((yyvsp[0].val)!=0) (yyval.val) = (yyvsp[-2].val)/(yyvsp[0].val); 
                              else { WE=1; yyerror(" Деление на 0 "); (yyval.val)=(yyvsp[-2].val); }
                            }
#line 1303 "calcf.c"
    break;
